...
public class RedisClusterIdempotenceStorage implements IdempotenceStorage {
     ...
     */
    public void RedisIdempotenceStorage(String redisClusterAddress, GenericObjectPoolConfig config) {
        Set<HostAndPort> redisNodes = parseHostAndPorts(redisClusterAddress);
        this.jedisCluster = new JedisCluster(redisNodes, config);
    }

    public void RedisIdempotenceStorage(JedisCluster jedisCluster) {
